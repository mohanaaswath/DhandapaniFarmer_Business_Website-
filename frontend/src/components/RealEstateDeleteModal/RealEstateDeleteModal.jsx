...
const RealEstateDeleteModal = () => {
  const { isDeleteOpen, deletingItem, closeDeleteConfirm, deleteProperty } = useRealEstate();
      ...
      <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-dark-50/80 backdrop-blur-md">
        ...
        >
          ...
          <div className="flex items-center gap-3.5 mb-4">
            ...
            <div>
              <h3 className="text-lg font-bold text-white font-display">Delete Property?</h3>
          ...
          <div className="my-5">
            <p className="text-sm text-dark-600 leading-relaxed">
              ...
              the real estate marketplace? This property listing will be permanently removed.
            </p>
          </div>
...
export default RealEstateDeleteModal;
